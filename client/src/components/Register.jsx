        ...
        <div className="row justify-content-md-center mt-4">
            <div className="col-lg-5 card border-primary mb-3">
                ...
                <div className="form-group">
                    ...
                    {
        errors?.name && <small id="emailHelp" className="form-text text-danger">{errors.name.msg}</small>
       }
...
{
        errors?.email && <small id="emailHelp" className="form-text text-danger">{errors.email.msg}</small>
       }
           ...
           {
        errors?.password && <small id="emailHelp" className="form-text text-danger">{errors.password.msg}</small>
       }
                    </div>
